...
def test_get_all_pets_with_invalid_key(filter=''):
    ...
    Далее пробуем используя этоn ключ запрасить список всех питомцев и проверить что список не пустой."""
...
def test_add_new_pet_with_valid_data_with_massive_data(name='Йцукенгшшззхъфывапролджячсмитьбю', animal_type='ъхзщшгнекуцйэждлорпавыфюбьтимсчя',
                                     age='450000', pet_photo='images/cat1.jpg'):
    """Проверяем что можно добавить питомца с большим значением имени, типа животного и возраста"""
...
def test_add_new_pet_with_valid_data_without_data(name='', animal_type='',
...
def test_successful_update_self_pet_info(name='Суперкот', animal_type='котэ', age=5):
